...
BEGIN
  ...
  VALUES
    -- Admins
    (admin1_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ujjwal@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Ujjwal","name":"Ujjwal","post":"Business Operations Associate (BOA)","email":"Ujjwal@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    (admin2_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'divesh@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Divesh","name":"Divesh","post":"Program Manager (PM)","email":"divesh@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    (admin3_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'pankaj@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Pankaj","name":"Pankaj","post":"Program Manager Associate (PMA)","email":"pankaj@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    
    -- Instructors
    (inst1_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'yash@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Yash","name":"Yash","post":"Tech Instructor (Frontend Technologies & GENAI )","email":"Yash@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    (inst2_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'skund@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Skund","name":"Skund","post":"Tech Instructor (Backend Systems)","email":"Skund@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    (inst3_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'inderjit@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Inderjit","name":"Inderjit","post":"English Instructor (English & Communication Studies)","email":"Inderjit@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now()),
    (inst4_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'rishabh@niat.in', crypt('password123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Rishabh","name":"Rishabh","post":"Mathematics Instructor (Maths & Aptitude)","email":"Rishabh@niat.in"}'::jsonb, '', '', '', '', '', '', '', '', now(), now());
